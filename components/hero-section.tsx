...
export function HeroSection() {
  return (
    <section id="inicio" className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <h1 className="text-4xl font-extrabold leading-tight text-[var(--text)] md:text-6xl">
