...
export function ContactSection() {
  return (
    <section id="contact" className="px-6 py-[120px]">
      <div className="glass-card relative mx-auto max-w-4xl overflow-hidden rounded-2xl border border-white/5 p-8 md:p-16">
        ...
        <div className="relative z-10 grid grid-cols-1 gap-16 md:grid-cols-2">
          <div className="space-y-8">
            <h2 className="text-4xl font-bold text-[var(--text)] md:text-5xl">¿Listo para escalar?</h2>
