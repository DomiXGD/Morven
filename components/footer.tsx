...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-[var(--surface-lowest)] py-[120px]">
      <div className="site-shell px-0">
        ...
        <div className="flex flex-col justify-between gap-4 border-t border-white/5 pt-8 text-sm text-[var(--muted)] md:flex-row">
